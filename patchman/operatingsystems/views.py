...
from patchman.operatingsystems.forms import (
...
from patchman.operatingsystems.serializers import (
    OSReleaseSerializer, OSVariantSerializer,
)
from patchman.operatingsystems.tables import OSReleaseTable, OSVariantTable

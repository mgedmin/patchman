...
from patchman.repos.repo_types.yast import refresh_yast_repo
from patchman.repos.repo_types.yum import refresh_yum_repo
from patchman.repos.utils import (
    check_for_metalinks, check_for_mirrorlists, fetch_mirror_data,
    find_mirror_url, get_max_mirrors,
)
from patchman.util import get_datetime_now
from patchman.util.logging import info_message, warning_message

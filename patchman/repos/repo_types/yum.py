...
from patchman.errata.sources.repos.yum import extract_updateinfo
from patchman.packages.models import Package, PackageString
from patchman.packages.utils import get_or_create_package, parse_package_string
from patchman.signals import pbar_start, pbar_update
from patchman.repos.utils import fetch_mirror_data, update_mirror_packages
from patchman.util import extract, stream_extract
...
def extract_module_metadata(data, url, repo):
    ...
    for i, doc in enumerate(modules_yaml):
        ...
        if document == 'modulemd':
            ...
            from patchman.modules.utils import get_or_create_module

...
class ReportSerializerTests(TestCase):
    ...
    def test_package_serializer_valid(self):
        from patchman.reports.serializers import PackageSerializer
        data = {
            'name': 'nginx',
            'epoch': '',
            'version': '1.18.0',
    ...
    def test_repo_serializer_valid(self):
        from patchman.reports.serializers import RepoSerializer
        data = {
            'type': 'deb',
            'name': 'Ubuntu Main',
            'id': 'ubuntu-main',
    ...
    def test_module_serializer_valid(self):
        from patchman.reports.serializers import ModuleSerializer
        data = {
            'name': 'nodejs',
            'stream': '18',

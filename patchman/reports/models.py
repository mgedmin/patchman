...
from patchman.hosts.utils import get_or_create_host
from patchman.util.logging import error_message, info_message
...
class Report(models.Model):
    ...
    def process(self, find_updates=True, verbose=False):
        ...
        from patchman.reports.utils import get_arch, get_domain, get_os

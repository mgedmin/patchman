...
@shared_task(
    name='reports.tasks.process_report',
    bind=True,
    priority=0,
...
@shared_task(name='reports.tasks.process_reports', priority=1)
def process_reports():
...
@shared_task(name='reports.tasks.remove_reports_with_no_hosts', priority=2)

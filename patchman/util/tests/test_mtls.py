...
from patchman.util.models import EnrollmentToken, ClientCertificate
...
@override_settings(
    PKI_PROVIDER='patchman.util.pki.StepCAProvider',
    PKI_PROVIDER_CONFIG={
...
-----END CERTIFICATE REQUEST-----"""
    ...
    @patch('patchman.util.views.get_pki_provider')
...
@override_settings(
    ...
    MIDDLEWARE=[
        ...
        'patchman.util.middleware.ClientCertMiddleware',
    ],
)
...
class MiddlewareTests(TestCase):
    ...
    def test_middleware_extracts_cn(self):
        ...
        from patchman.util.middleware import ClientCertMiddleware
...
class PKIProviderTests(TestCase):
    ...
    def test_get_pki_provider_returns_none_when_not_configured(self):
        ...
        from patchman.util.pki import get_pki_provider
    ...
    def test_get_pki_provider_returns_step_ca(self):
        ...
        from patchman.util.pki import StepCAProvider

...
from patchman.errata.managers import ErratumManager
from patchman.packages.models import Package, PackageUpdate
from patchman.packages.utils import find_evr, get_matching_packages_q
from patchman.security.models import CVE, Reference
from patchman.security.utils import get_or_create_cve, get_or_create_reference
from patchman.util import get_url
from patchman.util.logging import error_message

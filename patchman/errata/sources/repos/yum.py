...
from patchman.packages.utils import get_or_create_package
from patchman.signals import pbar_start, pbar_update
from patchman.security.models import Reference
from patchman.util import get_url, run_concurrently, stream_extract
from patchman.util.logging import clear_forked_pbar, error_message
...
def get_existing_el_osreleases(major_version):
    ...
    """
    from patchman.operatingsystems.models import OSRelease
    el_patterns = [

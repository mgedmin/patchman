...
from patchman.operatingsystems.utils import (
...
from patchman.util import fetch_content, get_setting_of_type, get_url, run_concurrently
from patchman.util.logging import clear_forked_pbar


def update_alma_errata(concurrent_processing=True, max_workers=25):
    """ Update Alma Linux advisories from patchman.errata.almalinux.org:

...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'patchman.util.context_processors.issues_count',
                'patchman.util.context_processors.patchman_version',
            ],
            'debug': DEBUG,
        },
    },
...
LOCAL_APPS = [
    ...
    'patchman.hosts.apps.HostsConfig',
    'patchman.modules.apps.ModulesConfig',
    'patchman.operatingsystems.apps.OperatingsystemsConfig',
...
# mTLS Client Certificate Authentication defaults
REQUIRE_CLIENT_CERT = False
CLIENT_CERT_CN_HEADER = 'HTTP_X_SSL_CLIENT_CN'
CLIENT_CERT_VERIFY_HEADER = 'HTTP_X_SSL_CLIENT_VERIFY'
CLIENT_CERT_STRICT_HOSTNAME = False
CLIENT_CERT_PROTECTED_PATHS = ['/api/report/', '/reports/upload/']
PKI_PROVIDER = None
PKI_PROVIDER_CONFIG = {}

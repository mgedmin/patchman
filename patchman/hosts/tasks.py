...
@shared_task(name='hosts.tasks.find_host_updates', priority=0)
...
@shared_task(name='hosts.tasks.find_all_host_updates', priority=1)
...
@shared_task(name='hosts.tasks.find_all_host_updates_homogenous', priority=1)

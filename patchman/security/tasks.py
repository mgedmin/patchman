...
from patchman.security.models import CVE, CWE
from patchman.util.logging import warning_message


@shared_task(name='security.tasks.update_cve', priority=3)
...
@shared_task(name='security.tasks.update_cves', priority=2)
def update_cves():
...
@shared_task(name='security.tasks.update_cwe', priority=3)
...
@shared_task(name='security.tasks.update_cwes', priority=2)
def update_cwes():

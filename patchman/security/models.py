...
from patchman.security.managers import CVEManager
from patchman.util import error_message, fetch_content, get_url, tz_aware_datetime
...
class CVE(models.Model):
    ...
    def parse_osv_dev_cve_data(self, cve_json):
        from patchman.security.utils import get_or_create_reference
